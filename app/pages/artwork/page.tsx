      ...
      <div className="flex-1 flex flex-col items-center px-4 md:px-8 pt-20 md:pt-24 pb-12">
        ...
        <div className="w-full max-w-5xl">
          ...
          <div className="flex flex-col lg:flex-row lg:items-stretch lg:gap-16">
           ...
           {/* RIGHT: Title + Info card + Quick Links + Polaroid */}
           ...
           <div className="mt-8 lg:mt-0 lg:w-[320px] lg:shrink-0 flex flex-col relative z-30">
              ...
              {/* Quick links - Visible on all screen sizes */}

              <div className="w-full mt-6 lg:mt-0 relative z-40">

                <p className="text-[9px] uppercase tracking-[0.2em] text-[#a89888] mb-3 text-center lg:text-left">Quick links</p>
              ...
              {/* THE POLAROID - HIDDEN on mobile, VISIBLE on lg+ */}

              <div className="hidden lg:block mt-8 transition-all duration-700 delay-100">

                 <div className="relative z-10 transform rotate-3 hover:rotate-0 transition-transform duration-300 ease-out origin-center mx-12 lg:mx-12 w-fit">
